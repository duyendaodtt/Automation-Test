Feature: Request
  ...
  Scenario: Get Activities
    Given I make a GET request to api/v1/Activities
  ...
  Scenario: Testing POST API with request body from external Json file
    Given I make a POST request to api/v1/Activities
    And I set body as postUser file
    When I receive a response
    Then I expect response should have a status 200
  ...
  Scenario: Testing PUT API
     Given I make a PUT request to api/v1/Activities/1
     And I set body to
     """
      {
          "id": 1,
